"""Tests for the tucuxi.sqs Module using some fixtures from conftest.py"""
import itertools
import logging
...
def test_send_message(sqs_url: str, objs: List[Dict[str, str]]) -> None:
    """[summary]
...
def test_send_message_batch(sqs_url: str, objs: List[Dict[str, str]]) -> None:
    """[summary]
...
def test_listen_to_message(sqs_url: str, objs: List[Dict[str, str]]) -> None:
    """[summary]
...
def test_delete_message(sqs_url: str, objs: List[Dict[str, str]]) -> None:
    """[summary]
...
def test_delete_message_batch(sqs_url: str, objs: List[Dict[str, str]]) -> None:
    """[summary]
