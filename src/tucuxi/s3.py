...
class S3:
    ...
    def get_object(self, obj_key, retries=0): # TODO Better exception handling and maybe async download
        try:
    ...
    def set_object(self, obj_key, obj_data): # TODO  More params, better exception handling and maybe async upload
